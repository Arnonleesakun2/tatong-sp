        ...
        <div class="con-show">
            ...
            <div class="d3 w-11/12 mx-auto ">
                ...
                <div class="">
                    ...
                    <input value="{{ $employee->positions->name }}" type="text"
                        class="input input-bordered w-full " />
                </div>
                <div class="">
                    <p>ต้องการเงินเดือนเท่าไร</p>
                    <input value="{{ $employee->needsalary }}" type="text" class="input input-bordered w-full " />
                </div>
            </div>
            ...
            <div class="mt-10 w-11/12 mx-auto mb-8">
                <div class="button text-center">
                    ...
                    <a class="btn btnmodify" style="--clr:#EF4C53" href="{{url('/ShowWaitting')}}">ย้อนกลับ</a>
                </div>
            </div>
        </div>
    </div>
